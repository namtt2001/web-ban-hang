				      		...
				      		<div class="form-group">
				      			...
				      			<div class="row">					      			
					      			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					      				...
					      				<textarea name="txtIntro" id="inputTxttxtIntro" class="form-control" rows="2" >{{ old('txtIntro') }}</textarea>
					      			</div>
					      			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					      				<label for="input-id">Bài viết chi tiết</label>
					      				<textarea name="txtFull" id="inputtxtFull" class="form-control" rows="4">{{ old('txtFull') }}</textarea>
					      			</div>
					      		</div>				      			
				      		</div>
				      		<input type="submit" name="btnCateAdd" class="btn btn-primary" value="Thêm tin mới" class="button" />
				      	</form>			      	
					</div>
				</div>
			</div>
