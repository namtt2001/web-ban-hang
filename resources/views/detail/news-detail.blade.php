              ...
              <div class="panel-body">
                <div class="row">
                  <div class="titledownload" style="padding-left: 25px;">
                    <h3><strong> {!! ucwords($data->title) !!}</strong></h3>
                      ...
                      <?php 
                        $t = str_replace(" ", "", $data->tag);
                        $tags = explode ( "," , $t); 
                      ?>
                      &nbsp;<i class="glyphicon glyphicon-tags"></i>:

                        @foreach($tags as $itemtags)             
                          <a href="{!!url('/news/tags/')!!}/{!!$itemtags !!}">{!!$itemtags !!}</a>,
                        @endforeach
      ...
      <div class="row">
       @foreach($last as $item)
          <div class="col-lg-12 no-padding">
            <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 no-padding">
              <a href="{!!url('/news/'.$item->id.'-'.$item->slug)!!}" class="view" news-id="{!! $item->id !!}">
               <img class="img-rounded" src="{!!url('public/uploads/news/'.$item->images)!!}" alt="news" width="99%" height="99%"> 
              </a>
            </div>
            <div class="col-xs-12 col-sm-9 col-md-9 col-lg-9 no-padding">
